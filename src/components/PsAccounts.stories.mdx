...
Case with two paying plan, with possibility to upgrade to more expensive plans:

<Story name='Connected with a two paying plan' height='470px'>
  {{
    components: { PsAccounts },
    props: {
      context: {
        default: object('context', {
          ...
          onboardingLink: 'http://pouet.com',
          superAdminEmail: 'big.boss@my-shop.com',
          ssoResendVerificationEmail: 'http://pouet.com',
          manageAccountLink: 'http://poeut.com',
          billing: {
            currentPlan: {
              id: '1234567',
              level: 42,
            ...
            plans: [
              ...
              },
              {
                ...
                level: 45,
                name: 'Sell',
                price: { taxIncluded: 500, currency: '€' },
                periodicity: 'monthly',
                recommended: true
              },
              {
                ...
                level: 47,
                name: 'Upper plan',
                price: { taxIncluded: 2000, currency: '€' },
                periodicity: 'monthly',
                recommended: false
              }
            ],
...
Case with module nede to be upgrade:

<Story name='Connected but need module upgrade' height='470px'>
  {{
    components: { PsAccounts },
    props: {
      context: {
        default: object('context', {
          psIs17: true,
          psModuleUpgradeLink: 'http://localhost:8082/admin-dev/index.php/improve/modules/manage/action/update/ps_accounts?_token=dCspOkG6tWwGoJIKdugKufBFtdNF--UPq8NVmyiUKLM',
          psAccountsInstallLink: null,
          psAccountsEnableLink: null,
          currentShop: {
            id: 1,
