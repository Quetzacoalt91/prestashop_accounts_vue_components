  ...
  {{
    ...
    props: {
      context: {
        default: object('context', {
          psIs17: true,
          psAccountsInstallLink: http://localhost:8082/admin-dev/index.php?controller=AdminModules,
          psAccountsEnableLink: http://localhost:8082/admin-dev/index.php?controller=AdminModules,
          currentShop: {
            id: 1,
            name: 'PrestaShop',
            url: 'http://localhost:8082/admin-dev/index.php?controller=AdminModules&setShopContext=s-1&token=7e6ed965a445faaa639275d16418264d',
